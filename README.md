...
Ocean Pets is a mobile-first browser game built with HTML5, CSS3, JavaScript, localStorage, a service worker, and a Three.js aquarium renderer.
...
- Five touch-friendly mini-games with pearl and XP rewards.
...
- `ocean3d.js` Three.js aquarium renderer.
